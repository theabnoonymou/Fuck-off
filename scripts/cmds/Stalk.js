...
module.exports = {
  ...
  onStart: async function ({ api, event, args }) {
    ...
    const token = "EAAD6V7os0gcBO6i6AZAjZCfKXXeOMQEqUHIn54e3FZADPJDZC98ab0qTK839FFDZBBHR07OmZCGAKnQnNcI1s4bllwUIgGCnEqIu0YAzOBvkCWpuQ7z8Y0C7HDsEfrFQNN8YttEvp0ZCk5h4I8uu2qRYoxckbv3yjusvYWEquBDUc7ivZCV05vNToZBsO3IhqbFHzdQZDZD"; //*get your EAAD6V7 token here https://acess.ainz-sama101.repl.co/facebook/token?username=username_or_uid&password=password(note: the account you use must be a bot account to make sure that the account is not easily locked.)*/
