...
module.exports = {
  ...
  onStart: async function ({ api, event }) {
    ...
    api.sendMessage('🔴🟡🟢\n\n╭─❍\n➠•Invalid command.\n╰───────────⟡\n╭─❍\n➠•"shoticronv2 on", "shoticron off" - to turn ON or turn OFF.\n╰───────────⟡\n╭─❍\n➠•"shoticronv2 setinterval <minutes/hours>" - set the timer for video\n╰───────────⟡\n╭─❍\n➠•"shoticronv2 interval" - check the interval\n╰───────────⟡\n╭─❍\n➠•"shoticronv2 status" - check the status off command\n╰───────────⟡\n', threadID);
  },
};
