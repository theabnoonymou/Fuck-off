 module.exports = {
		...
		onStart: async function ({ api, event, args }) {
				...
				let t = args.join(" ");
				if (!t) return api.sendMessage('⚠️ Missing prompt!', event.threadID, event.messageID);
				api.sendMessage('♻️ Processing request please wait...', event.threadID, event.messageID);
